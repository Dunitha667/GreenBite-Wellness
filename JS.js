...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const recipes = [
    ...
    {id:5, title:"Veggie Omelette", category:"Breakfast", image:"images/omelette.webp", description:"Fluffy omelette with vegetables.", ingredients:["2 eggs","Bell peppers, onion, spinach","Salt & pepper","1 tsp olive oil"], steps:["Whisk eggs with salt & pepper.","Pour into pan and add veggies.","Cook until set.","Fold and serve."], nutrition:{Calories:"220 kcal", Protein:"14 g", Carbs:"6 g", Fat:"15 g"}},
    {id:6, title:"Peanut Butter Toast", category:"Breakfast", image:"images/peanut-butter-toast.jpg", description:"Nutty toast for a protein boost.", ingredients:["2 slices whole grain bread","2 tbsp peanut butter","Banana slices"], steps:["Toast bread.","Spread peanut butter.","Top with banana slices."], nutrition:{Calories:"290 kcal", Protein:"9 g", Carbs:"30 g", Fat:"14 g"}},
    {id:7, title:"Chia Pudding", category:"Breakfast", image:"images/chia-pudding.jpg", description:"Overnight chia seeds pudding.", ingredients:["3 tbsp chia seeds","1 cup almond milk","Honey or maple syrup","Fresh berries"], steps:["Mix chia seeds with almond milk.","Refrigerate overnight.","Top with honey and berries."], nutrition:{Calories:"200 kcal", Protein:"6 g", Carbs:"20 g", Fat:"10 g"}},
    {id:8, title:"Fruit Salad", category:"Breakfast", image:"images/fruit-salad.webp", description:"Refreshing mix of seasonal fruits.", ingredients:["Apple","Orange","Grapes","Kiwi"], steps:["Cut fruits into cubes.","Mix in a bowl.","Serve chilled."], nutrition:{Calories:"180 kcal", Protein:"2 g", Carbs:"45 g", Fat:"0 g"}},
    ...
    {id:13, title:"Turkey Sandwich", category:"Lunch", image:"images/turkey-sandwich.webp", description:"Lean protein sandwich with veggies.", ingredients:["2 slices whole grain bread","Turkey breast","Lettuce, tomato","Mustard"], steps:["Spread mustard on bread.","Layer turkey & veggies.","Cut diagonally & serve."], nutrition:{Calories:"310 kcal", Protein:"20 g", Carbs:"34 g", Fat:"9 g"}},
    {id:14, title:"Quinoa Salad", category:"Lunch", image:"images/quinoa-salad.jpg", description:"Refreshing salad with quinoa & veggies.", ingredients:["1 cup cooked quinoa","Cucumber, tomato, corn","Olive oil & lemon"], steps:["Cook quinoa.","Mix with vegetables.","Drizzle with dressing."], nutrition:{Calories:"350 kcal", Protein:"11 g", Carbs:"55 g", Fat:"12 g"}},
    {id:15, title:"Grilled Veggie Sandwich", category:"Lunch", image:"images/grilled-veggie-sandwich.jpg", description:"Veggies in whole wheat bread.", ingredients:["Whole wheat bread","Grilled zucchini & peppers","Hummus"], steps:["Assemble sandwich.","Grill until golden."], nutrition:{Calories:"280 kcal", Protein:"8 g", Carbs:"40 g", Fat:"10 g"}},
    {id:16, title:"Chickpea Salad", category:"Lunch", image:"images/chickpea-salad.jpg", description:"Protein-rich chickpea salad.", ingredients:["Chickpeas","Cucumber, tomato, onion","Olive oil & lemon"], steps:["Mix all ingredients.","Serve chilled."], nutrition:{Calories:"330 kcal", Protein:"14 g", Carbs:"50 g", Fat:"12 g"}},
    ...
    {id:21, title:"Tofu Stir-Fry", category:"Dinner", image:"images/tofu-stirfry.jpg", description:"Quick stir-fried tofu with vegetables.", ingredients:["200g tofu","Soy sauce, garlic","Broccoli, carrots, peppers","Sesame oil"], steps:["Cube tofu & fry.","Add vegetables.","Pour soy sauce.","Stir-fry until tender."], nutrition:{Calories:"380 kcal", Protein:"18 g", Carbs:"25 g", Fat:"20 g"}},
    {id:22, title:"Grilled Shrimp Skewers", category:"Dinner", image:"images/shrimp-skewers.jpg", description:"Light dinner with protein-packed shrimp.", ingredients:["8 shrimp","Bell peppers, onion","Olive oil, garlic"], steps:["Skewer shrimp & veggies.","Grill 5-7 minutes.","Serve hot."], nutrition:{Calories:"320 kcal", Protein:"30 g", Carbs:"10 g", Fat:"12 g"}},
    {id:23, title:"Vegetable Stir Fry", category:"Dinner", image:"images/veg-stirfry.jpg", description:"Quick stir-fried veggies for dinner.", ingredients:["Broccoli, carrots, peppers","Soy sauce, garlic","Sesame oil"], steps:["Stir-fry vegetables.","Add sauce.","Serve hot."], nutrition:{Calories:"290 kcal", Protein:"10 g", Carbs:"35 g", Fat:"10 g"}},
    {id:24, title:"Mushroom Risotto", category:"Dinner", image:"images/mushroom-risotto.jpg", description:"Creamy mushroom risotto.", ingredients:["Arborio rice","Mushrooms","Vegetable broth","Parmesan cheese"], steps:["Cook mushrooms.","Add rice & broth gradually.","Stir until creamy.","Add cheese."], nutrition:{Calories:"400 kcal", Protein:"12 g", Carbs:"65 g", Fat:"12 g"}},
    ...
    {id:29, title:"Roasted Chickpeas", category:"Snacks", image:"images/roasted-chickpeas.jpg", description:"Crispy and savory protein snack.", ingredients:["1 cup chickpeas","Olive oil","Salt & paprika"], steps:["Toss chickpeas in oil & spices.","Roast at 200°C for 25 mins.","Cool & enjoy."], nutrition:{Calories:"230 kcal", Protein:"11 g", Carbs:"30 g", Fat:"8 g"}},
    {id:30, title:"Celery with Peanut Butter", category:"Snacks", image:"images/celery-pb.webp", description:"Crunchy celery sticks with protein spread.", ingredients:["3 celery sticks","2 tbsp peanut butter"], steps:["Fill celery sticks with peanut butter.","Serve chilled."], nutrition:{Calories:"180 kcal", Protein:"6 g", Carbs:"10 g", Fat:"12 g"}},
    {id:31, title:"Energy Balls", category:"Snacks", image:"images/energy-balls.jpg", description:"No-bake energy bites.", ingredients:["Oats","Peanut butter","Honey","Chocolate chips"], steps:["Mix all ingredients.","Roll into balls.","Chill before serving."], nutrition:{Calories:"250 kcal", Protein:"7 g", Carbs:"30 g", Fat:"12 g"}},
    {id:32, title:"Veggie Chips", category:"Snacks", image:"images/veggie-chips.jpg", description:"Baked vegetable chips.", ingredients:["Carrot, zucchini, beetroot","Olive oil","Salt"], steps:["Slice veggies thinly.","Bake until crisp.","Serve as snack."], nutrition:{Calories:"160 kcal", Protein:"3 g", Carbs:"20 g", Fat:"6 g"}}
  ];
